...
var app = angular.module("webapp-app", ['ngRoute', 'ngCookies', 'ngTouch']);
...
app.run(function($rootScope, $http) {
    $rootScope.message = "";
    $rootScope.token = clientData.getItem('token');
    $rootScope.username = clientData.getItem('username');
    $http.defaults.headers.common.Authorization = 'Apikey '+BROWSER_APIKEY;
